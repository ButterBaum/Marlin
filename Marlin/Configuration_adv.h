...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_MIN_TRIGGER   300     // (°C) Minimum temperature to enable hotend protection
...
//#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_USE_NEOPIXEL           // Use NeoPixel LED as case light, requires NEOPIXEL_LED.
    ...
    #define CASE_LIGHT_NEOPIXEL_COLOR { 125, 125, 125, 125 } // { Red, Green, Blue, White }
  #endif
#endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      320  // (mm) The length of filament for a complete unload.

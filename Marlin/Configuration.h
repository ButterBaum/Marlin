...
#define STRING_CONFIG_H_AUTHOR "(Tim J. Warmels)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  30.42,  22.20 }
    #define DEFAULT_Ki_LIST {   3.04,   1.08 }
    #define DEFAULT_Kd_LIST {  76.02, 114.00 }
  #else
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 3000, 3000, 1500, 50 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 4000, 4000, 2500, 75 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 750, 10000 }

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 3000, 6000, 750, 20000 } // ...or, set your own edit limits
#endif
...
#define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 16, 16, 0.6, 15 } // ...or, set your own edit limits
  #endif
#endif
...
#define Z_HOMING_HEIGHT 12      // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 230
...
#define HOMING_FEEDRATE_MM_M { (50*62), (50*62), (15*60) }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 35, 35 , 20 }
  //#define NOZZLE_PARK_X_ONLY          // X move only is required to park
  //#define NOZZLE_PARK_Y_ONLY          // Y move only is required to park
  #define NOZZLE_PARK_Z_RAISE_MIN   5   // (mm) Always raise Z by at least this distance
  #define NOZZLE_PARK_XY_FEEDRATE 1000   // (mm/s) X and Y axes feedrate (also used for delta Z axis)
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 47       // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
